...
public class OpenIdAuthenticationFilter  extends
    ...
    public OpenIdAuthenticationFilter() {
        super(new AntPathRequestMatcher(SecurityConstants.DEFAULT_SIGN_IN_PROCESSING_URL_OEPNID, "POST"));
    }
     ...
     */
    public void setUsernameParameter(String openIdParameter) {
     ...
     */
    public void setPasswordParameter(String providerIdParameter) {
